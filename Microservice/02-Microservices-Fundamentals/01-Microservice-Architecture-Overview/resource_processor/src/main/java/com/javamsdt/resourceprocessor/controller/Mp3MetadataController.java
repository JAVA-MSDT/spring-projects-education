package com.javamsdt.resourceprocessor.controller;

import com.javamsdt.resourceprocessor.model.Mp3Metadata;
import com.javamsdt.resourceprocessor.service.Mp3MetadataService;
...
public class Mp3MetadataController {
    ...
    @PostMapping(value = "/{resource-id}")
    public ResponseEntity<Mp3Metadata> saveMp3Metadata(@RequestBody MultipartFile mp3File, @PathVariable("resource-id") Long resourceId) {
        Mp3Metadata metadata = mp3MetadataService.saveMp3Metadata(mp3File, resourceId);
